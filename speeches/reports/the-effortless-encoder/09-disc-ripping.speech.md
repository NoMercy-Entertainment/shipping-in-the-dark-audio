...
Part nine. From shelf to library.
...
So far we have been talking about encoding on a single machine. Part ten covers what happens when you have more than one machine available.
